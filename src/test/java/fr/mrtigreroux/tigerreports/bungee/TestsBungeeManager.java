...
public class TestsBungeeManager {
	...
	public void expectPluginNotification(BungeeNotificationType notifType, BiConsumer<BungeeNotification, Runnable> notifOnReceiveCallback)
		...
		doAnswer((inv) -> {
			...
			doAnswer((inv2) -> {
				notifOnReceiveCallback.accept(notif, () -> {
					notif.onReceive(inv2.getArgument(0), inv2.getArgument(1), inv2.getArgument(2), inv2.getArgument(3), inv2.getArgument(4), inv2.getArgument(5));
				});
