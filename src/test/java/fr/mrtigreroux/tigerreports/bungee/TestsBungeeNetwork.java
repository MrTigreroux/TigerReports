...
public class TestsBungeeNetwork {
    ...
    /**
     * Warning: Returns the same Basic2ServersNetwork, using the same BungeeManager instances (not
     * cleaned). The TestsTaskScheduler instances are cleaned.
     * 
     * @return
     */
    ...
    public static class Basic2ServersNetwork extends TestsBungeeNetwork {
        ...
        public Basic2ServersNetwork() {
            ...
            TestsBungeeManager server1TestsBm =
                    TestsBungeeManager.newBasicTestsBungeeManager(server1, this);
            TestsBungeeManager server2TestsBm =
                    TestsBungeeManager.newBasicTestsBungeeManager(server2, this);
    ...
    /**
     * Clean task schedulers of all fake servers after having used it (typically after a test
     * execution).
     * 
    ...
    public void addFakeServer(FakeServer server) {
        if (servers.put(server.name, server) != null) {
            throw new IllegalArgumentException(
                    "The fake server named " + server.name + " was already added"
            );
        }
    }
    ...
    public static class FakeServer {
        ...
        public static void setupUMForGetOnlineUser(UsersManager um, Player playerMock,
                User userMock) {
