...
public class VaultManager {
    ...
    private static final Logger LOGGER =
            Logger.fromClass(VaultManager.DisplayNameResultCallback.class);
    ...
    private boolean setupChat() {
        ...
        Logger.CONFIG.error(
                ConfigUtils.getInfoMessage(
                        "The Chat of Vault plugin could not be used.",
    ...
    public void getVaultDisplayNameAsynchronously(OfflinePlayer p, String name,
            TaskScheduler taskScheduler, DisplayNameResultCallback resultCallback) {
    ...
    private String getVaultDisplayName(OfflinePlayer p, String name) {
        ...
        String playerPrefix =
                (playerPrefix = chat.getPlayerPrefix(null, p)) != null ? playerPrefix : "";
        String playerSuffix =
                (playerSuffix = chat.getPlayerSuffix(null, p)) != null ? playerSuffix : "";
        String vaultDisplayName = MessageUtils.translateColorCodes(
                ConfigFile.CONFIG.get().getString("VaultChat.Format").replace("_Prefix_", playerPrefix).replace("_Name_", name).replace("_Suffix_", playerSuffix)
        );
