...
public class ReportsPageCharacteristics {
    ...
    public static ReportsPageCharacteristics fromString(String reportsPageCharacteristics) {
        String[] tokens = reportsPageCharacteristics
                .split(ReportsCharacteristics.REPORTS_CHARACTERISTICS_SEPARATOR);
        return tokens.length >= 4
                ? new ReportsPageCharacteristics(
                        ReportsCharacteristics.fromStrings(tokens[0], tokens[1], tokens[2]),
    ...
    public boolean equals(Object obj) {
        ...
        return page == other.page
                && Objects.equals(reportsCharacteristics, other.reportsCharacteristics);
    }
    
    @Override
    public String toString() {
        return String.join(
                ReportsCharacteristics.REPORTS_CHARACTERISTICS_SEPARATOR,
                reportsCharacteristics.toString(),
