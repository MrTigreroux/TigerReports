...
public class ReportsCharacteristics {
    ...
    public static final ReportsCharacteristics CURRENT_REPORTS =
            new ReportsCharacteristics(null, null, false);
    public static final ReportsCharacteristics ARCHIVED_REPORTS =
            new ReportsCharacteristics(null, null, true);
    ...
    public static ReportsCharacteristics fromStrings(String reporterUUID, String reportedUUID,
            String archived) {
        return new ReportsCharacteristics(
                !NULL_UUID.equals(reporterUUID) ? UUID.fromString(reporterUUID) : null,
                !NULL_UUID.equals(reportedUUID) ? UUID.fromString(reportedUUID) : null,
    ...
    public boolean equals(Object obj) {
        ...
        return archived == other.archived
                && Objects.equals(reportedUUID, other.reportedUUID)
    ...
    public String toString() {
        return String.join(
                REPORTS_CHARACTERISTICS_SEPARATOR,
                reporterUUID != null ? reporterUUID.toString() : NULL_UUID,
                reportedUUID != null ? reportedUUID.toString() : NULL_UUID,
