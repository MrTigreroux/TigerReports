 ...
 * @author MrTigreroux
 */
public abstract class ReportsPageMenu extends Menu
        implements ReportsPage.ReportsPageListener, UpdatedMenu {
    ...
    public ReportsPageMenu(User u, int size, int page, Permission permission,
        ...
        this.um = um;
        reportsPage = rm
                .getAndListenReportsPage(reportsCharacteristics, page, this, db, taskScheduler, um);
    }
