...
public class Report {
	...
	private String reportedName = null;
	private String signalmanName = null;
	...
	public String implementData(String message, boolean advanced) {
		...
		return message.replace("_Reported_", getPlayerName("Reported", true)).replace("_DefaultData_", defaultData).replace("_AdvancedData_", !advanced ? "" : reportedAdvancedData+Message.ADVANCED_DATA_SIGNALMAN.get().replace("_Player_", getPlayerName("Signalman", true))
		...
		if(!bungee) {
			...
			Bukkit.getScheduler().runTaskAsynchronously(TigerReports.getInstance(), () -> {
                TigerReports.getDb().update("REPLACE INTO reports (report_id,status,appreciation,date,reported_uuid,signalman_uuid,reason,reported_ip,reported_location,reported_messages,reported_gamemode,reported_on_ground,reported_sneak,reported_sprint,reported_health,reported_food,reported_effects,signalman_ip,signalman_location,signalman_messages) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);",
                        Arrays.asList(reportId, status, appreciation, date, reportedUniqueId, signalmanUniqueId, reason, advancedData.get("reported_ip"),
								advancedData.get("reported_location"), advancedData.get("reported_messages"), advancedData.get("reported_gamemode"), advancedData.get("reported_on_ground"), advancedData.get("reported_sneak"), advancedData.get("reported_sprint"), advancedData.get("reported_health"), advancedData.get("reported_food"),
								advancedData.get("reported_effects"), advancedData.get("signalman_ip"), advancedData.get("signalman_location"), advancedData.get("signalman_messages")));
