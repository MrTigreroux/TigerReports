...
public class PlayerLastMessagesBungeeNotification extends BungeeNotification {
	...
	public PlayerLastMessagesBungeeNotification(long creationTime, UUID playerUUID, List<User.SavedMessage> lastMessages) {
		this(creationTime, playerUUID.toString(), Report.AdvancedData.serializeMessages(lastMessages));
	}

	public PlayerLastMessagesBungeeNotification(long creationTime, String playerUniqueId, String serializedLastMessages) {
		super(creationTime);
