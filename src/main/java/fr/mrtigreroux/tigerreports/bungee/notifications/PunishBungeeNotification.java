...
public class PunishBungeeNotification extends BungeeNotification {
	...
	public PunishBungeeNotification(long creationTime, UUID staffUUID, UUID targetUUID, long seconds) {
		this(creationTime, staffUUID.toString(), targetUUID.toString(), seconds);
	}

	public PunishBungeeNotification(long creationTime, String staffUniqueId, String targetUniqueId, long seconds) {
		super(creationTime);
