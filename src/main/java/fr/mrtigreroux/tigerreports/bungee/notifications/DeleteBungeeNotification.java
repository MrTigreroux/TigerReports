...
public class DeleteBungeeNotification extends BungeeNotification {
    ...
    public DeleteBungeeNotification(long creationTime, String reportBasicDataString,
            UUID staffUUID) {
    ...
    public void onReceive(Database db, TaskScheduler ts, UsersManager um, ReportsManager rm,
        ...
        if (reportData == null) {
            throw new IllegalStateException(
                    "Invalid reportBasicDataString: " + reportBasicDataString
            );
        }
        ...
        Report.asynchronouslyFrom(reportData, false, db, ts, um, (r) -> {
            if (r == null) {
                LOGGER.error(
                        "Report.asynchronouslyFrom failed for reportBasicDataString = "
                                + reportBasicDataString
                );
                return;
            }
