...
public class ProcessBungeeNotification extends BungeeNotification {
    ...
    public ProcessBungeeNotification(long creationTime, int reportId, UUID staffUUID,
            boolean archive, Appreciation appreciation) {
        this(creationTime, reportId, staffUUID.toString(), archive, appreciation.getConfigName());
    }
    
    public ProcessBungeeNotification(long creationTime, int reportId, String staffUniqueId,
            boolean archive, String serializedAppreciation) {
        super(creationTime);
