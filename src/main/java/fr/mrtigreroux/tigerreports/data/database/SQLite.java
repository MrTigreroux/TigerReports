...
public class SQLite extends Database {
	...
	public void initialize() {
		Bukkit.getScheduler().runTaskAsynchronously(TigerReports.getInstance(), () -> {
			...
			update("CREATE TABLE IF NOT EXISTS report_comments ('comment_id' INTEGER PRIMARY KEY, 'report_id' INTEGER NOT NULL, 'status' varchar(7),'date' varchar(20),'author' varchar(32), 'message' varchar(255));", null);
        });
	}
