...
public abstract class ReportManagerMenu extends Menu {
	...
	String checkReport() {
		...
		return (reportStatus == Status.IMPORTANT || reportStatus == Status.DONE) && !Permission.ADVANCED.isOwned(u) ? Message.PERMISSION_ACCESS_DETAILS.get().replace("_Report_", r.getName()) : null;
	}
